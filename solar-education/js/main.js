...
// Feature imports
import { openSiteBuilder, closeSiteBuilder, resetSiteBuilder, sbSelect, sbUpdateUI, getConfigNumber } from './features/siteBuilder.js';
import { closePanelStyleTooltip, changePanelStyle, rebuildSolarFarm } from './features/panelStyles.js';
import { openSiteViewer, closeSiteViewer, svResetView, svTopView, svToggleAuto } from './features/siteViewer.js';

// Scene imports
import { mkPanelTex, mkGroundTex, mkGravelTex } from './scene/textureGenerator.js';
...
// New generators
import { openCreateSite, closeCreateSite } from './features/createSite.js';
import { openCreateEbosSite, closeCreateEbosSite } from './features/createEbosSite.js';
...
window.openSiteViewer = openSiteViewer;
window.closeSiteViewer = closeSiteViewer;
window.svResetView = svResetView;
window.svTopView = svTopView;
window.svToggleAuto = svToggleAuto;
window.openCreateSite = openCreateSite;
window.closeCreateSite = closeCreateSite;
window.openCreateEbosSite = openCreateEbosSite;
window.closeCreateEbosSite = closeCreateEbosSite;
    ...
    function init3D() {
      ...
      // Expose camera for compass widget and external modules
      window._mainCamera = camera;
      window._mainCameraTarget = { x: targetX, y: targetY, z: targetZ };
    ...
    function animate() {
      ...
      // Sync camera target for compass widget
      if (window._mainCameraTarget) {
        window._mainCameraTarget.x = targetX;
        window._mainCameraTarget.y = targetY;
        window._mainCameraTarget.z = targetZ;
      }
      updateCompass();
    ...
    function zoomToCombinerDemo() {
      ...
      document.getElementById('stats').innerHTML = `
        <div class="stat-card" style="background: linear-gradient(135deg, #00aa66, #00cc88);">
          <div class="stat-value" style="font-size: 14px;">🔍 COMBINER BOX - DOOR OPEN</div>
