/**
 * siteViewer.js
 * Fullscreen 3D site viewer with camera controls and rendering
...
export function svResetView(){svOrbit.tTh=-0.45;svOrbit.tPh=1.2;svOrbit.tR=140;if(svOrbit.tTgt)svOrbit.tTgt.set(0,3,0);}
export function svTopView(){svOrbit.tTh=0;svOrbit.tPh=0.06;svOrbit.tR=200;if(svOrbit.tTgt)svOrbit.tTgt.set(0,0,0);}
export function svToggleAuto(){svOrbit.autoRotate=!svOrbit.autoRotate;document.getElementById('svAutoBtn').classList.toggle('active');}
